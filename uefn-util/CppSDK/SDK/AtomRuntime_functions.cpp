...
struct FAtomModelPartsCollection UAtomPartsCollectionBlueprintLibrary::FilterCommonPartsToStyle(struct FAtomModelPartsCollection& PartsCollection, class FName GeometryStyle)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AtomPartsCollectionBlueprintLibrary", "FilterCommonPartsToStyle");
...
bool UAtomPartsCollectionBlueprintLibrary::PrimitiveHasConsistentCommonPartStyles(class UAtomPrimitive* Primitive)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AtomPartsCollectionBlueprintLibrary", "PrimitiveHasConsistentCommonPartStyles");
...
class UAtomPrimitiveGeometry* UAtomPrimitiveGeometry::ConvertVertexColorsLinearToSRGB()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AtomPrimitiveGeometry", "ConvertVertexColorsLinearToSRGB");
...
// Function AtomRuntime.AtomPrimitiveGeometryContainer.GetAlphaMaskTextureName
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// class FString                           ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class FString UAtomPrimitiveGeometryContainer::GetAlphaMaskTextureName() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AtomPrimitiveGeometryContainer", "GetAlphaMaskTextureName");

	Params::AtomPrimitiveGeometryContainer_GetAlphaMaskTextureName Parms{};
...
// Function AtomRuntime.AtomPrimitiveGeometryContainer.GetNormalMapTextureName
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// class FString                           ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class FString UAtomPrimitiveGeometryContainer::GetNormalMapTextureName() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AtomPrimitiveGeometryContainer", "GetNormalMapTextureName");

	Params::AtomPrimitiveGeometryContainer_GetNormalMapTextureName Parms{};
...
float UAtomRuntimeBlueprintLibrary::GetBitPackForLUTMaterial(int32 ColorId, const struct FGuid& PrimitiveUUID, int32 VariantId)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AtomRuntimeBlueprintLibrary", "GetBitPackForLUTMaterial");
...
bool UAtomModelComponent::ModelSupportsMaterialInstancePayload() const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AtomModelComponent", "ModelSupportsMaterialInstancePayload");
...
struct FVector UAtomPrimitive::GetCenterOfMass(float Scale) const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AtomPrimitive", "GetCenterOfMass");
...
int32 UAtomPrimitive::GetDecorationSurfaceIndex(const class FString& SurfaceName) const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AtomPrimitive", "GetDecorationSurfaceIndex");
