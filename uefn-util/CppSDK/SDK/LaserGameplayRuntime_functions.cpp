...
// Function LaserGameplayRuntime.BuildingGameplayActorLaserGrid.CosmeticLaserConnectionsUpdated
// (BlueprintCosmetic, Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
// TArray<struct FLaserGridConnectionEntry>NewLaserGridConnections                                (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)

void ABuildingGameplayActorLaserGrid::CosmeticLaserConnectionsUpdated(const TArray<struct FLaserGridConnectionEntry>& NewLaserGridConnections)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BuildingGameplayActorLaserGrid", "CosmeticLaserConnectionsUpdated");

	Params::BuildingGameplayActorLaserGrid_CosmeticLaserConnectionsUpdated Parms{};

	Parms.NewLaserGridConnections = std::move(NewLaserGridConnections);
