...
public:
	...
	EHairCardsSourceType                          SourceType;                                        // 0x0014(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UHairCardGenerationSettings*            GenerationSettings;                                // 0x0088(0x0008)(ZeroConstructor, EditorOnly, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FHairGroupCardsInfo                    CardsInfo;                                         // 0x0090(0x0008)(Edit, Transient, EditConst, NoDestructor, NativeAccessSpecifierPublic)
	class FString                                 ImportedMeshKey;                                   // 0x0098(0x0010)(ZeroConstructor, Transient, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FHairGroupCardsTextures                Textures;                                          // 0x0020(0x0050)(Edit, NativeAccessSpecifierPublic)
	int32                                         GroupIndex;                                        // 0x0070(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         LODIndex;                                          // 0x0074(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ImportedMeshKey;                                   // 0x0078(0x0010)(ZeroConstructor, Transient, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
