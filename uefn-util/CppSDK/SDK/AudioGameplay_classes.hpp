...
{
public:
	struct FGameplayTagContainer                  MetadataTags;                                      // 0x0030(0x0020)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
public:
	...
	TMulticastInlineDelegate<void()>              OnStopped;                                         // 0x0278(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnKilled;                                          // 0x0288(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnVirtualized;                                     // 0x0298(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnUnvirtualized;                                   // 0x02A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TArray<class UAudioComponent*>                Components;                                        // 0x02B8(0x0010)(Edit, ExportObject, ZeroConstructor, EditConst, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
{
public:
	struct FGameplayTagQuery                      Query;                                             // 0x0038(0x0048)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
public:
	...
	TMulticastInlineDelegate<void(struct FAudioParameter& Parameter)> OnParameterChanged;                                // 0x00F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, EditorOnly, NativeAccessSpecifierPublic)
	TArray<TWeakObjectPtr<class UAudioComponent>> ActiveComponents;                                  // 0x0100(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<struct FAudioParameter>                Parameters;                                        // 0x0110(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
