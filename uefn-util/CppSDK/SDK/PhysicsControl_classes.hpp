...
public:
	...
	struct FPhysicsControlCharacterSetupData      CharacterSetupData;                                // 0x0038(0x00C0)(NativeAccessSpecifierPublic)
	struct FPhysicsControlAndBodyModifierCreationDatas AdditionalControlsAndModifiers;                    // 0x00F8(0x00A0)(NativeAccessSpecifierPublic)
	struct FPhysicsControlSetUpdates              AdditionalSets;                                    // 0x0198(0x0020)(NativeAccessSpecifierPublic)
	TArray<struct FPhysicsControlControlAndModifierUpdates> InitialControlAndModifierUpdates;                  // 0x01B8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class FName, struct FPhysicsControlControlAndModifierUpdates> Profiles;                                          // 0x01C8(0x0050)(NativeAccessSpecifierPublic)
	bool                                          bAutoCompileProfiles;                              // 0x0218(0x0001)(Edit, ZeroConstructor, IsPlainOldData, EditorOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAutoInvokeProfiles;                               // 0x0219(0x0001)(Edit, ZeroConstructor, IsPlainOldData, EditorOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAutoCompileSetup;                                 // 0x021A(0x0001)(Edit, ZeroConstructor, IsPlainOldData, EditorOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAutoReinitSetup;                                  // 0x021B(0x0001)(Edit, ZeroConstructor, IsPlainOldData, EditorOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAutoInvokeProfileAfterSetup;                      // 0x021C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, EditorOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_21D[0x3];                                      // 0x021D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class UPhysicsControlAsset>    ParentAsset;                                       // 0x0220(0x0030)(Edit, EditorOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<TSoftObjectPtr<class UPhysicsControlAsset>> AdditionalProfileAssets;                           // 0x0250(0x0010)(Edit, ZeroConstructor, EditorOnly, UObjectWrapper, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UPhysicsAsset>           PhysicsAsset;                                      // 0x0260(0x0030)(Edit, EditorOnly, AssetRegistrySearchable, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPhysicsControlCharacterSetupData      MyCharacterSetupData;                              // 0x0290(0x00C0)(Edit, EditorOnly, NativeAccessSpecifierPublic)
	struct FPhysicsControlAndBodyModifierCreationDatas MyAdditionalControlsAndModifiers;                  // 0x0350(0x00A0)(Edit, EditorOnly, NativeAccessSpecifierPublic)
	struct FPhysicsControlSetUpdates              MyAdditionalSets;                                  // 0x03F0(0x0020)(Edit, EditorOnly, NativeAccessSpecifierPublic)
	TArray<struct FPhysicsControlControlAndModifierUpdates> MyInitialControlAndModifierUpdates;                // 0x0410(0x0010)(Edit, ZeroConstructor, EditorOnly, NativeAccessSpecifierPublic)
	TMap<class FName, struct FPhysicsControlControlAndModifierUpdates> MyProfiles;                                        // 0x0420(0x0050)(Edit, EditorOnly, NativeAccessSpecifierPublic)
	uint8                                         Pad_470[0x18];                                     // 0x0470(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void Compile();

	TArray<class FName> GetDirtyProfiles() const;
...
{
public:
	TSoftObjectPtr<class UPhysicsControlAsset>    PhysicsControlAsset;                               // 0x0270(0x0030)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bWarnAboutInvalidNames;                            // 0x02E8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2E9[0x1F7];                                    // 0x02E9(0x01F7)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	struct FInitialCharacterControls              InitialCharacterControls;                          // 0x0270(0x00D8)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TMap<class FName, struct FInitialPhysicsControl> InitialControls;                                   // 0x0348(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TMap<class FName, struct FInitialBodyModifier> InitialBodyModifiers;                              // 0x0398(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          bCreateControlsAtBeginPlay;                        // 0x03E8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	class UPhysicsControlComponent*               ControlComponent;                                  // 0x0420(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPhysicsControlInitializerComponent*    ControlInitializerComponent;                       // 0x0428(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
