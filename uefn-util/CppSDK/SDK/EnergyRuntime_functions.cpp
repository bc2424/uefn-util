...
void UFortEnergyAttrSet::OnRep_EnergyUsageMultiplier(const struct FFortGameplayAttributeData& OldValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortEnergyAttrSet", "OnRep_EnergyUsageMultiplier");

	Params::FortEnergyAttrSet_OnRep_EnergyUsageMultiplier Parms{};
...
void UFortEnergyAttrSet::OnRep_MaxEnergy(const struct FFortGameplayAttributeData& OldValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortEnergyAttrSet", "OnRep_MaxEnergy");

	Params::FortEnergyAttrSet_OnRep_MaxEnergy Parms{};
...
void UFortEnergyAttrSet::OnRep_RechargeAmountPerSecond(const struct FFortGameplayAttributeData& OldValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortEnergyAttrSet", "OnRep_RechargeAmountPerSecond");

	Params::FortEnergyAttrSet_OnRep_RechargeAmountPerSecond Parms{};
