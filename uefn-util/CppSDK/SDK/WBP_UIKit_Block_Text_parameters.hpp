...
{
public:
	struct FSlateFontInfo                         Font;                                              // 0x0000(0x0070)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
};
...
public:
	...
	struct FSlateFontInfo                         K2Node_MakeStruct_SlateFontInfo;                   // 0x0028(0x0070)(HasGetValueTypeHash)
};
