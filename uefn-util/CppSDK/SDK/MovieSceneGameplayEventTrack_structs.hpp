...
{
public:
	struct FMemberReference                       GameplayEventFunctionProperty;                     // 0x0000(0x0038)(Edit, NativeAccessSpecifierPublic)
	struct FInstancedPropertyBag                  Payload;                                           // 0x0038(0x0010)(Edit, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FMemberReference                       GameplayEventFunctionProperty;                     // 0x0000(0x0038)(NativeAccessSpecifierPublic)
	struct FInstancedPropertyBag                  Payload;                                           // 0x0038(0x0010)(NativeAccessSpecifierPublic)
	struct FGuid                                  ObjectBindingID;                                   // 0x0048(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
