...
public:
	...
	TSet<int32>                                   SelfCollisionVertexSet;                            // 0x00B0(0x0050)(Edit, NativeAccessSpecifierPublic)
	struct FClothTetherData                       EuclideanTethers;                                  // 0x0100(0x0010)(Edit, NativeAccessSpecifierPublic)
	struct FClothTetherData                       GeodesicTethers;                                   // 0x0110(0x0010)(Edit, NativeAccessSpecifierPublic)
	int32                                         MaxBoneWeights;                                    // 0x0120(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumFixedVerts;                                     // 0x0124(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<uint32>                                SelfCollisionIndices;                              // 0x0128(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<float>                                 MaxDistances;                                      // 0x0138(0x0010)(ZeroConstructor, Deprecated, EditorOnly, NativeAccessSpecifierPublic)
	TArray<float>                                 BackstopDistances;                                 // 0x0148(0x0010)(ZeroConstructor, Deprecated, EditorOnly, NativeAccessSpecifierPublic)
	TArray<float>                                 BackstopRadiuses;                                  // 0x0158(0x0010)(ZeroConstructor, Deprecated, EditorOnly, NativeAccessSpecifierPublic)
	TArray<float>                                 AnimDriveMultipliers;                              // 0x0168(0x0010)(ZeroConstructor, Deprecated, EditorOnly, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FClothPhysicalMeshData                 PhysicalMeshData;                                  // 0x0000(0x0178)(Edit, NativeAccessSpecifierPublic)
	bool                                          bUseMultipleInfluences;                            // 0x0178(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_179[0x3];                                      // 0x0179(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SkinningKernelRadius;                              // 0x017C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSmoothTransition;                                 // 0x0180(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_181[0x7];                                      // 0x0181(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FClothCollisionData                    CollisionData;                                     // 0x0188(0x0040)(Deprecated, EditorOnly, NativeAccessSpecifierPublic)
	TArray<struct FClothParameterMask_Legacy>     ParameterMasks;                                    // 0x01C8(0x0010)(ZeroConstructor, Deprecated, EditorOnly, NativeAccessSpecifierPublic)
	TArray<struct FPointWeightMap>                PointWeightMaps;                                   // 0x01D8(0x0010)(Edit, ZeroConstructor, EditorOnly, NativeAccessSpecifierPublic)
