...
public:
	...
	TWeakObjectPtr<class UObject>                 FunctionEntry;                                     // 0x000C(0x0008)(ZeroConstructor, IsPlainOldData, EditorOnly, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint32                                        DisplayOrder;                                      // 0x0014(0x0004)(ZeroConstructor, IsPlainOldData, EditorOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
