...
{
public:
	TSoftClassPtr<class UClass>                   ActorClass;                                        // 0x0020(0x0030)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 JsonStringObjectForPropertyData;                   // 0x0050(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
