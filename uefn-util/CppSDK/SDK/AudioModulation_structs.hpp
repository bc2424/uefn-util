...
public:
	...
	float                                         TargetUnitValue;                                   // 0x0004(0x0004)(Edit, ZeroConstructor, Transient, IsPlainOldData, EditorOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FSoundModulationMixValue               Value;                                             // 0x0008(0x0024)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	class FText                                   UnitDisplayName;                                   // 0x0008(0x0010)(Edit, EditorOnly, NativeAccessSpecifierPublic)
	float                                         ValueUnit;                                         // 0x0018(0x0004)(Edit, ZeroConstructor, Transient, IsPlainOldData, EditorOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	struct FSoundModulationTransform              Transform;                                         // 0x0008(0x0138)(Edit, NativeAccessSpecifierPublic)
	class USoundControlBus*                       Bus;                                               // 0x0140(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
