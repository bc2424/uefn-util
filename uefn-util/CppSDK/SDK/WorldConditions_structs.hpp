...
{
public:
	uint8                                         ExpressionDepth;                                   // 0x0000(0x0001)(Edit, ZeroConstructor, IsPlainOldData, EditorOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EWorldConditionOperator                       Operator;                                          // 0x0001(0x0001)(Edit, ZeroConstructor, IsPlainOldData, EditorOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bInvert;                                           // 0x0002(0x0001)(Edit, ZeroConstructor, IsPlainOldData, EditorOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3[0x5];                                        // 0x0003(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FInstancedStruct                       Condition;                                         // 0x0008(0x0010)(Edit, EditorOnly, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<struct FWorldConditionEditable>        EditableConditions;                                // 0x0018(0x0010)(Edit, ZeroConstructor, EditorOnly, NativeAccessSpecifierPrivate)
};
...
{
public:
	struct FWorldConditionQueryDefinition         QueryDefinition;                                   // 0x0000(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FWorldConditionQueryState              QueryState;                                        // 0x0028(0x0030)(Transient, Protected, NativeAccessSpecifierProtected)
};
...
{
public:
	class FName                                   Name;                                              // 0x0000(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
