...
// ScriptStruct ChaosNiagara.ResolvedNiagaraGeometryCollection
// 0x0010 (0x0010 - 0x0000)
struct FResolvedNiagaraGeometryCollection final
{
public:
	TWeakObjectPtr<class UGeometryCollection>     Collection;                                        // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class UGeometryCollectionComponent> Component;                                         // 0x0008(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
