...
void AJamPlayspace::OnJamAudioSourceActiveStateChange(class UAudioComponent* JamAudioSource, bool bNewActiveState)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("JamPlayspace", "OnJamAudioSourceActiveStateChange");
...
class AJamPlayspaceVolume* AJamPlayspace::GetJamPlayspaceVolume() const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("JamPlayspace", "GetJamPlayspaceVolume");
...
const struct FGuid AJamPlayspace::GetJamSessionGuid() const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("JamPlayspace", "GetJamSessionGuid");
...
bool UJamPlayspaceComponent_JamCompanion::GetShouldPlaySongAlone() const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("JamPlayspaceComponent_JamCompanion", "GetShouldPlaySongAlone");
...
// Parameters:
// struct FJamPlayParams                   OldPlayParams                                          (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
// (Final, Native, Public, HasOutParams)
// Parameters:
// struct FJamPlayParams                   PlayParams                                             (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
void UJamPlayspaceComponent_MusicManager::OnSuppressEmoteMusicInJamChanged()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("JamPlayspaceComponent_MusicManager", "OnSuppressEmoteMusicInJamChanged");
...
void AJamPlayspaceVolume::BP_OnPlayspaceSet()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("JamPlayspaceVolume", "BP_OnPlayspaceSet");
