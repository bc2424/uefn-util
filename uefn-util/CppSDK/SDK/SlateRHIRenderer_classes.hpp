...
{
public:
	TMap<ESlatePostRT, class USlateRHIPostBufferProcessor*> SlatePostBufferProcessors;                         // 0x0038(0x0050)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
{
public:
	float                                         GaussianBlurStrength;                              // 0x0030(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	TMap<ESlatePostRT, struct FSlatePostSettings> SlatePostSettings;                                 // 0x0060(0x0050)(Edit, EditFixedSize, Config, NativeAccessSpecifierPrivate)
