...
public:
	...
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FComponentReference                    ComponentRef;                                      // 0x0010(0x0030)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSoftComponentReference                SoftComponentRef;                                  // 0x0040(0x0058)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FDirectoryPath                         USDCacheDirectory;                                 // 0x00A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
