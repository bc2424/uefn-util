...
void UFortVehicleEngineAudioRegistry::RegisterVehicleEntry(const struct FVehicleEngineAudioRegistryEntryRequest& InRequest)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FortVehicleEngineAudioRegistry", "RegisterVehicleEntry");
...
void UFortVehicleEngineAudioRegistry::RemoveVehicleEntry(const TScriptInterface<class IBudgetedEngineAudioUser>& VehicleToRemove)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FortVehicleEngineAudioRegistry", "RemoveVehicleEntry");
...
// Function VehicleAudioRuntime.FortVehicleSoundComponent_Boost.OnBoostFinished
// (Final, Native, Private)

void UFortVehicleSoundComponent_Boost::OnBoostFinished()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortVehicleSoundComponent_Boost", "OnBoostFinished");
...
// Function VehicleAudioRuntime.FortVehicleSoundComponent_Boost.OnBoostStarted
// (Final, Native, Private)

void UFortVehicleSoundComponent_Boost::OnBoostStarted()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortVehicleSoundComponent_Boost", "OnBoostStarted");
...
// Function VehicleAudioRuntime.FortVehicleAudioController.ToggleEngineSoundNative
...
void AFortVehicleAudioController::ToggleEngineSoundNative(const float FadeInDuration, const float FadeOutDuration)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortVehicleAudioController", "ToggleEngineSoundNative");

	Params::FortVehicleAudioController_ToggleEngineSoundNative Parms{};
