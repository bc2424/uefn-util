...
void UFortGameplayAbility_ScoutDrone_Tether::Client_SetIsInSignalLossRange(bool bValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortGameplayAbility_ScoutDrone_Tether", "Client_SetIsInSignalLossRange");

	Params::FortGameplayAbility_ScoutDrone_Tether_Client_SetIsInSignalLossRange Parms{};
...
void UFortGameplayAbility_ScoutDrone_Tether::Client_SetIsInWarningRange(bool bValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortGameplayAbility_ScoutDrone_Tether", "Client_SetIsInWarningRange");

	Params::FortGameplayAbility_ScoutDrone_Tether_Client_SetIsInWarningRange Parms{};
