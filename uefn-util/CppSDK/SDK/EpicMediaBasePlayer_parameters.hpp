...
struct EpicBaseStreamingVideo_SetPriorityInfo final
{
public:
	struct FEpicMediaPriorityInfo                 InPriorityInfo;                                    // 0x0000(0x0003)(Parm, NoDestructor, NativeAccessSpecifierPublic)
};
...
// 0x0003 (0x0003 - 0x0000)
struct EpicBaseStreamingVideo_GetPriorityInfo final
{
public:
	struct FEpicMediaPriorityInfo                 ReturnValue;                                       // 0x0000(0x0003)(Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)
};
