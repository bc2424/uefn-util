...
// ScriptStruct FMCoreRuntime.FMCoreEvent_AutoCalibrationCompleted
// 0x0004 (0x0004 - 0x0000)
struct FFMCoreEvent_AutoCalibrationCompleted final
{
public:
	float                                         AutoCalibrationLatencyMs;                          // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
