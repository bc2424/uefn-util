...
// Parameters:
// struct FCraftingObjectRepStateData      OldValue                                               (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
// struct FCraftingMultiKey                Key                                                    (Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   OverriddenObjectStateLength                            (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// struct FCraftingIngredientUIData        NewRowStruct                                           (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void UCraftingLibrary::AddCraftingIngredientUIDataRow(class UDataTable* DataTable, const class FName& RowName, const struct FCraftingIngredientUIData& NewRowStruct)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("CraftingLibrary", "AddCraftingIngredientUIDataRow");

	Params::CraftingLibrary_AddCraftingIngredientUIDataRow Parms{};
...
// int32                                   NumberToCraft                                          (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FGameplayTagContainer            InInventoryGroups                                      (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
// int32                                   NumberToCraft                                          (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FCraftingMultiKey                Key                                                    (Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   OverriddenCraftingLength                               (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
