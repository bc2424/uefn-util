...
void UDaySequenceModifierComponent::EnableDistanceVolumeBlends(class APlayerController* InActor)
{
	static class UFunction* Func = nullptr;
...
// Function DaySequence.ProceduralDaySequenceBuilder.AddStaticTime
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// float                                   StaticTime                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UProceduralDaySequenceBuilder::AddStaticTime(float StaticTime)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("ProceduralDaySequenceBuilder", "AddStaticTime");

	Params::ProceduralDaySequenceBuilder_AddStaticTime Parms{};

	Parms.StaticTime = StaticTime;
...
// Function DaySequence.ProceduralDaySequenceBuilder.ClearAllKeys
// (Final, Native, Public, BlueprintCallable)
...
void UProceduralDaySequenceBuilder::ClearAllKeys()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("ProceduralDaySequenceBuilder", "ClearAllKeys");
...
// Function DaySequence.ProceduralDaySequenceBuilder.ClearScalarKeys
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class FName                             PropertyName                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UProceduralDaySequenceBuilder::ClearScalarKeys(class FName PropertyName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ProceduralDaySequenceBuilder", "ClearScalarKeys");

	Params::ProceduralDaySequenceBuilder_ClearScalarKeys Parms{};
