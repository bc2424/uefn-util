...
public:
	...
	TArray<float>                                 SourcePCMData;                                     // 0x0058(0x0010)(ZeroConstructor, EditorOnly, NativeAccessSpecifierPrivate)
};
...
public:
	...
	struct FWaveTableSettings                     WaveTableSettings;                                 // 0x00B8(0x0068)(Edit, EditorOnly, NativeAccessSpecifierPublic)
	TArray<float>                                 WaveTable;                                         // 0x0120(0x0010)(ZeroConstructor, EditorOnly, NativeAccessSpecifierPublic)
	float                                         FinalValue;                                        // 0x0130(0x0004)(ZeroConstructor, IsPlainOldData, EditorOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FWaveTableTransform                    Transform;                                         // 0x0000(0x0138)(Edit, NativeAccessSpecifierPublic)
};
