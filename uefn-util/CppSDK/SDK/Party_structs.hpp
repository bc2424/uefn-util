...
public:
	...
	struct FPartyMemberPlatformData               PlatformData;                                      // 0x0028(0x00A0)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_C8[0x90];                                      // 0x00C8(0x0090)(Fixing Size After Last Property [ Dumper-7 ])
	ECrossplayPreference                          CrossplayPreference;                               // 0x0158(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_159[0x37];                                     // 0x0159(0x0037)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 JoinMethod;                                        // 0x0190(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1A0[0x30];                                     // 0x01A0(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPartyMemberJoinInProgressData         JoinInProgressData;                                // 0x01D0(0x0048)(NativeAccessSpecifierPrivate)
