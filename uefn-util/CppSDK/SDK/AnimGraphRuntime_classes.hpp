...
public:
	...
	void Prototype_ThreadSafeAnimNodeCall(const struct FAnimExecutionContext& Context, const struct FAnimNodeReference& Node);
	void Prototype_ThreadSafeAnimUpdateCall(const struct FAnimUpdateContext& Context, const struct FAnimNodeReference& Node);
