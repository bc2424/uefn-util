...
public:
	...
	TArray<class FName>                           SuppressExtenders;                                 // 0x00B0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_C0[0xE8];                                      // 0x00C0(0x00E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
