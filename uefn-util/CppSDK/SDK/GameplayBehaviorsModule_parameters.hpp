...
{
public:
	struct FValueOrBBKey_GameplayTagContainer     Value;                                             // 0x0000(0x0038)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	...
	struct FGameplayTagContainer                  ReturnValue;                                       // 0x0040(0x0020)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FBlackboardKeySelector                 InSelector;                                        // 0x0000(0x0030)(Parm, OutParm, NativeAccessSpecifierPublic)
...
public:
	class UBTNode*                                NodeOwner;                                         // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FBlackboardKeySelector                 Key;                                               // 0x0008(0x0030)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FGameplayTagContainer                  Value;                                             // 0x0038(0x0020)(Parm, NativeAccessSpecifierPublic)
};
...
public:
	...
	class FName                                   KeyName;                                           // 0x0008(0x000C)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  GameplayTagValue;                                  // 0x0018(0x0020)(Parm, NativeAccessSpecifierPublic)
};
