...
{
public:
	class FName                                   NewSurface;                                        // 0x0000(0x000C)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FVehicleEngineAudioRegistryEntryRequest InRequest;                                         // 0x0000(0x0040)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
// 0x0008 (0x0008 - 0x0000)
struct FortVehicleAudioController_ToggleEngineSoundNative final
{
public:
