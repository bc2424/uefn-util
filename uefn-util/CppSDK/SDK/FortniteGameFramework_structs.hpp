...
{
public:
	TSoftObjectPtr<class UStateTree>              StateTreeAsset;                                    // 0x0000(0x0030)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShouldReplicate;                                  // 0x0030(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FStateTreeInstanceData                 StateTreeInstanceData;                             // 0x0010(0x0020)(NativeAccessSpecifierPublic)
...
{
public:
	TArray<struct FStateChangeData>               StateChangeDataList;                               // 0x0110(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	class UStateTreeManagerComponent*             StateTreeManagerComponent;                         // 0x0120(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
