...
// (Final, Native, Protected)
// Parameters:
// bool                                    bIsMounted                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UClamberingComponent::HandleOwnerPersonalVehicleModeChanged(bool bIsMounted)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ClamberingComponent", "HandleOwnerPersonalVehicleModeChanged");

	Params::ClamberingComponent_HandleOwnerPersonalVehicleModeChanged Parms{};

	Parms.bIsMounted = bIsMounted;
