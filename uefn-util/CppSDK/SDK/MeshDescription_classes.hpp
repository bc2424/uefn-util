...
public:
	...
	class UMeshDescriptionBase*                   PreallocatedMeshDescription;                       // 0x0038(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, EditorOnly, NoDestructor, Protected, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMeshDescriptionBase*                   MeshDescription;                                   // 0x0040(0x0008)(ZeroConstructor, Transient, EditorOnly, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
