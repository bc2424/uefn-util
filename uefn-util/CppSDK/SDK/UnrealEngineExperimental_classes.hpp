...
{
public:
	TArray<struct FPersistentLineBatcher>         PersistentLineBatchers;                            // 0x00D8(0x0010)(ZeroConstructor, Transient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
