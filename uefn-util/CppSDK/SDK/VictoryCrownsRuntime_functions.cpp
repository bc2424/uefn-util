...
// Function VictoryCrownsRuntime.FortCheatManager_VictoryCrowns.VictoryCrownsGrantCrown
// (Final, BlueprintAuthorityOnly, Exec, Native, Public)
// Parameters:
// int32                                   CrownLevel                                             (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortCheatManager_VictoryCrowns::VictoryCrownsGrantCrown(const int32 CrownLevel)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortCheatManager_VictoryCrowns", "VictoryCrownsGrantCrown");

	Params::FortCheatManager_VictoryCrowns_VictoryCrownsGrantCrown Parms{};

	Parms.CrownLevel = CrownLevel;
...
// Function VictoryCrownsRuntime.FortControllerComponent_VictoryCrowns.GetVictoryCrownLevel
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// const int32                             ReturnValue                                            (ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

const int32 UFortControllerComponent_VictoryCrowns::GetVictoryCrownLevel() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortControllerComponent_VictoryCrowns", "GetVictoryCrownLevel");

	Params::FortControllerComponent_VictoryCrowns_GetVictoryCrownLevel Parms{};
...
// Function VictoryCrownsRuntime.FortGameStateComponent_VictoryCrowns.GetVictoryCrownLevelFromItemTrackerGuid
// (Final, Native, Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// int32                                   OutVictoryCrownLevel                                   (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FGuid                            VictoryCrownItemTrackerGuid                            (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UFortGameStateComponent_VictoryCrowns::GetVictoryCrownLevelFromItemTrackerGuid(int32* OutVictoryCrownLevel, const struct FGuid& VictoryCrownItemTrackerGuid) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortGameStateComponent_VictoryCrowns", "GetVictoryCrownLevelFromItemTrackerGuid");

	Params::FortGameStateComponent_VictoryCrowns_GetVictoryCrownLevelFromItemTrackerGuid Parms{};

	Parms.VictoryCrownItemTrackerGuid = std::move(VictoryCrownItemTrackerGuid);
	...
	if (OutVictoryCrownLevel != nullptr)
		*OutVictoryCrownLevel = Parms.OutVictoryCrownLevel;
