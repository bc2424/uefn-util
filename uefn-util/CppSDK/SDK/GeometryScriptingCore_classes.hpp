...
public:
	...
	static void GetMaterialListFromStaticMesh(class UStaticMesh* FromStaticMeshAsset, TArray<class UMaterialInterface*>* MaterialList, class UGeometryScriptDebug* Debug);
