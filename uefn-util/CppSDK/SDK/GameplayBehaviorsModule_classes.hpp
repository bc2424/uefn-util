...
{
public:
	struct FBlackboardKeySelector                 ActorForGameplayTagQuery;                          // 0x0078(0x0030)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagQuery                      GameplayTagQuery;                                  // 0x00A8(0x0048)(Edit, Protected, NativeAccessSpecifierProtected)
	TArray<struct FGameplayTag>                   QueryTags;                                         // 0x00F0(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
{
public:
	TSubclassOf<class UGameplayBehavior>          BehaviorToStop;                                    // 0x0080(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	struct FGameplayTagContainer                  DefaultValue;                                      // 0x0038(0x0020)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
