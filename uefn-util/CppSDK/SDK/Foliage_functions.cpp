...
// Function Foliage.InstancedFoliageActor.AddInstances
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable, EditorOnly)
// Parameters:
// class UObject*                          WorldContextObject                                     (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UFoliageType*                     InFoliageType                                          (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TArray<struct FTransform>               InTransforms                                           (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)

void AInstancedFoliageActor::AddInstances(class UObject* WorldContextObject, class UFoliageType* InFoliageType, const TArray<struct FTransform>& InTransforms)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("InstancedFoliageActor", "AddInstances");

	Params::InstancedFoliageActor_AddInstances Parms{};

	Parms.WorldContextObject = WorldContextObject;
	Parms.InFoliageType = InFoliageType;
...
// Function Foliage.InstancedFoliageActor.RemoveAllInstances
// (Final, Native, Static, Public, BlueprintCallable, EditorOnly)
// Parameters:
// class UObject*                          WorldContextObject                                     (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UFoliageType*                     InFoliageType                                          (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void AInstancedFoliageActor::RemoveAllInstances(class UObject* WorldContextObject, class UFoliageType* InFoliageType)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("InstancedFoliageActor", "RemoveAllInstances");

	Params::InstancedFoliageActor_RemoveAllInstances Parms{};
