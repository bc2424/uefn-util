...
{
public:
	TSoftClassPtr<class UClass>                   EmotePickerClass;                                  // 0x05D0(0x0030)(Edit, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	TSubclassOf<class UJamSongIndicator>          JamSongIndicatorClass;                             // 0x00E0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FUserWidgetPool                        IndicatorPool;                                     // 0x00E8(0x0088)(Transient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
