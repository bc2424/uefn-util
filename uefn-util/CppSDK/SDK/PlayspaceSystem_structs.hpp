...
// Enum PlayspaceSystem.EPlayspaceJurisdictionFilterState
// NumValues: 0x0004
enum class EPlayspaceJurisdictionFilterState : uint8
{
	Initialized                              = 0,
	PendingResolve                           = 1,
	Resolved                                 = 2,
...
{
public:
	TSoftClassPtr<class UClass>                   PlayspaceClass;                                    // 0x0000(0x0030)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPlayspaceCreationType                        CreationType;                                      // 0x0030(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bForceSyncLoad;                                    // 0x0031(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_32[0x6];                                       // 0x0032(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};

// ScriptStruct PlayspaceSystem.PlayspaceJurisdictionFilter
// 0x0068 (0x0068 - 0x0000)
struct FPlayspaceJurisdictionFilter final
{
public:
	uint8                                         Pad_0[0x20];                                       // 0x0000(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                ContextObject;                                     // 0x0020(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UObject*                                RequesterObject;                                   // 0x0028(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                   TargetPlayspaceClass;                              // 0x0030(0x0030)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPlayspaceJurisdictionFilterState             State;                                             // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};

// ScriptStruct PlayspaceSystem.PlayspaceExternallyReachableListenRequest
// 0x0080 (0x0080 - 0x0000)
struct FPlayspaceExternallyReachableListenRequest final
{
public:
	struct FPlayspaceJurisdictionFilter           Filter;                                            // 0x0000(0x0068)(NativeAccessSpecifierPublic)
...
{
public:
	TSoftClassPtr<class UClass>                   PlayspaceComponentClass;                           // 0x0000(0x0030)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPlayspaceComponentCreationType               CreationType;                                      // 0x0030(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagQuery                      TagQuery;                                          // 0x0038(0x0048)(Edit, NativeAccessSpecifierPublic)
	struct FVector                                Location;                                          // 0x0080(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<struct FPlayspaceUser>                 PlayspaceUsers;                                    // 0x0110(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_120[0x54];                                     // 0x0120(0x0054)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bIsInitialized;                                    // 0x0174(0x0001)(ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_175[0x3];                                      // 0x0175(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class APlayspace*                             Playspace;                                         // 0x0178(0x0008)(ZeroConstructor, Transient, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
