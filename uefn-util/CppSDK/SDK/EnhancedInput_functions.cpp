...
// (Final, Native, Static, Public, BlueprintCallable, BlueprintPure)
// Parameters:
// ETriggerEvent                           TriggerEvent                                           (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class FString                           ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
const TArray<class FName> UPlayerMappableKeySettings::GetKnownMappingNames()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("PlayerMappableKeySettings", "GetKnownMappingNames");

	Params::PlayerMappableKeySettings_GetKnownMappingNames Parms{};
