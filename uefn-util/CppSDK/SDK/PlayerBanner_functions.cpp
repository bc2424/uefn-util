...
// Function PlayerBanner.PlayerBanner_C.Update Material Instance
// (Public, BlueprintCallable, BlueprintEvent)

void UPlayerBanner_C::Update_Material_Instance()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PlayerBanner_C", "Update Material Instance");
