...
{
public:
	struct FChooserStructPropertyBinding          Binding;                                           // 0x0000(0x0050)(Edit, NativeAccessSpecifierPublic)
	struct FInstancedStruct                       Value;                                             // 0x0050(0x0010)(Edit, NoClear, NativeAccessSpecifierPublic)
};
...
public:
	...
	class FName                                   Key;                                               // 0x0008(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FInstancedStruct                       ValueStruct;                                       // 0x0018(0x0010)(Edit, NoClear, NativeAccessSpecifierPublic)
	TArray<struct FProxyStructOutput>             OutputStructData;                                  // 0x0028(0x0010)(Edit, ZeroConstructor, NoClear, NativeAccessSpecifierPublic)
};
