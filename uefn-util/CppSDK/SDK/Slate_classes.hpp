...
public:
	...
	struct FButtonStyle                           ButtonStyle;                                       // 0x0040(0x0420)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
public:
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FCheckBoxStyle                         CheckBoxStyle;                                     // 0x0040(0x0B10)(Edit, NativeAccessSpecifierPublic)
...
// 0x06C8 (0x0700 - 0x0038)
class UComboBoxWidgetStyle final : public USlateWidgetStyleContainerBase
{
public:
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FComboBoxStyle                         ComboBoxStyle;                                     // 0x0040(0x06C0)(Edit, NativeAccessSpecifierPublic)
...
public:
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FComboButtonStyle                      ComboButtonStyle;                                  // 0x0040(0x0630)(Edit, NativeAccessSpecifierPublic)
...
public:
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FEditableTextBoxStyle                  EditableTextBoxStyle;                              // 0x0040(0x0F00)(Edit, NativeAccessSpecifierPublic)
