...
public:
	...
	TSoftObjectPtr<class UTexture2D>              PreviewImage;                                      // 0x0028(0x0030)(ConstParm, Parm, OutParm, ReferenceParm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TSoftObjectPtr<class USoundCue>               SoundCue;                                          // 0x0060(0x0030)(ConstParm, Parm, OutParm, ReferenceParm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EFortAccoladeTierType                         AccoladeTier;                                      // 0x0090(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TSoftObjectPtr<class UTexture2D>              AccoladeLargePreviewImageOverride;                 // 0x0020(0x0030)(ConstParm, Parm, OutParm, ReferenceParm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   SimulatedName;                                     // 0x0050(0x0010)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	class FText                                   SimulatedText;                                     // 0x0060(0x0010)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	EFortSimulatedXPSize                          SimulatedXPSize;                                   // 0x0070(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
