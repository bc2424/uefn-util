...
bool ULearningAgentsActions::GetStructActionElement(struct FLearningAgentsActionObjectElement* OutElement, const class ULearningAgentsActionObject* Object, const struct FLearningAgentsActionObjectElement& Element, const class FName ElementName, const class FName Tag)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("LearningAgentsActions", "GetStructActionElement");

	Params::LearningAgentsActions_GetStructActionElement Parms{};
...
// bool                                    bVisualLoggerEnabled                                   (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class ULearningAgentsManagerListener*   VisualLoggerListener                                   (Parm, ZeroConstructor, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int32                                   VisualLoggerAgentId                                    (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FVector                          VisualLoggerLocation                                   (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FLinearColor                     VisualLoggerColor                                      (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool ULearningAgentsObservations::GetStructObservationElement(struct FLearningAgentsObservationObjectElement* OutElement, const class ULearningAgentsObservationObject* Object, const struct FLearningAgentsObservationObjectElement& Element, const class FName ElementName, const class FName Tag)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("LearningAgentsObservations", "GetStructObservationElement");

	Params::LearningAgentsObservations_GetStructObservationElement Parms{};
