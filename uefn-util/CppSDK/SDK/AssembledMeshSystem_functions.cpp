...
// Function AssembledMeshSystem.AssembledMeshSchema.SetCustomizableObjectInstance
// (Final, Native, Public, BlueprintCallable, EditorOnly)
// Parameters:
// TSoftObjectPtr<class UCustomizableObjectInstance>InCustomizableObjectInstance                           (Parm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UAssembledMeshSchema::SetCustomizableObjectInstance(TSoftObjectPtr<class UCustomizableObjectInstance> InCustomizableObjectInstance)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AssembledMeshSchema", "SetCustomizableObjectInstance");

	Params::AssembledMeshSchema_SetCustomizableObjectInstance Parms{};

	Parms.InCustomizableObjectInstance = InCustomizableObjectInstance;
...
// Function AssembledMeshSystem.AssembledMeshSchema.GetCustomizableObjectInstance
// (Final, Native, Public, BlueprintCallable, BlueprintPure, EditorOnly, Const)
// Parameters:
// TSoftObjectPtr<class UCustomizableObjectInstance>ReturnValue                                            (Parm, OutParm, ReturnParm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)

TSoftObjectPtr<class UCustomizableObjectInstance> UAssembledMeshSchema::GetCustomizableObjectInstance() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AssembledMeshSchema", "GetCustomizableObjectInstance");

	Params::AssembledMeshSchema_GetCustomizableObjectInstance Parms{};
