...
public:
	...
	struct FLiveLinkGamepadInputDeviceFrameData   InputDeviceData;                                   // 0x0018(0x0120)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
};
...
public:
	class FName                                   SubjectName;                                       // 0x0008(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   PropertyName;                                      // 0x0014(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
