...
struct PictureInPictureCheatManager_SendTestMeshNetworkStartPiPEvent final
{
public:
	int32                                         EventHours;                                        // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         EventMinutes;                                      // 0x0004(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         EventSeconds;                                      // 0x0008(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct PictureInPictureSubsystem_HandleLobbyPiPDataReceived final
{
public:
	struct FJsonObjectWrapper                     JsonWrapper;                                       // 0x0000(0x0020)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
// 0x0008 (0x0008 - 0x0000)
struct PictureInPictureSubsystem_OnEventInvalid final
{
public:
...
// 0x0008 (0x0008 - 0x0000)
struct PictureInPictureSubsystem_OnMeshNetworkEventValid final
{
public:
	const class UMediaCMSEvent*                   ValidEvent;                                        // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
