...
struct AssembledMeshSchema_SetCustomizableObjectInstance final
{
public:
	TSoftObjectPtr<class UCustomizableObjectInstance> InCustomizableObjectInstance;                      // 0x0000(0x0030)(Parm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};

// Function AssembledMeshSystem.AssembledMeshSchema.GetCustomizableObjectInstance
// 0x0030 (0x0030 - 0x0000)
struct AssembledMeshSchema_GetCustomizableObjectInstance final
{
public:
	TSoftObjectPtr<class UCustomizableObjectInstance> ReturnValue;                                       // 0x0000(0x0030)(Parm, OutParm, ReturnParm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
