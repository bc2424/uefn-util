...
TArray<class UAnimSequence*> UFortMantisData::GetSequencesFromMontage(const class UAnimMontage* Montage)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("FortMantisData", "GetSequencesFromMontage");

	Params::FortMantisData_GetSequencesFromMontage Parms{};
...
// EStripAnimDataOnDedicatedServerSettings ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

EStripAnimDataOnDedicatedServerSettings UFortMantisData::GetStripDataFromServerForAnimSequence(class UAnimSequence* AnimSequence)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("FortMantisData", "GetStripDataFromServerForAnimSequence");

	Params::FortMantisData_GetStripDataFromServerForAnimSequence Parms{};
...
// Parameters:
// class UAnimSequence*                    AnimSequence                                           (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EStripAnimDataOnDedicatedServerSettings StripDataOnDedicatedServerSettings                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortMantisData::SetStripDataFromServerForAnimSequence(class UAnimSequence* AnimSequence, EStripAnimDataOnDedicatedServerSettings StripDataOnDedicatedServerSettings)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("FortMantisData", "SetStripDataFromServerForAnimSequence");

	Params::FortMantisData_SetStripDataFromServerForAnimSequence Parms{};

	Parms.AnimSequence = AnimSequence;
	Parms.StripDataOnDedicatedServerSettings = StripDataOnDedicatedServerSettings;
