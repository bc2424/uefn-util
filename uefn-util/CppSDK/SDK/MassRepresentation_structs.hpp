...
public:
	...
	uint8                                         bCanModifyRepresentationActorManagementClass : 1;  // 0x000C(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, DisableEditOnInstance, EditorOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
