...
// Function AnimGraphRuntime.AnimExecutionContextLibrary.Prototype_ThreadSafeAnimNodeCall
// (Final, Native, Public, HasOutParams, EditorOnly)
// Parameters:
// struct FAnimExecutionContext            Context                                                (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct FAnimNodeReference               Node                                                   (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)

void UAnimExecutionContextLibrary::Prototype_ThreadSafeAnimNodeCall(const struct FAnimExecutionContext& Context, const struct FAnimNodeReference& Node)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AnimExecutionContextLibrary", "Prototype_ThreadSafeAnimNodeCall");

	Params::AnimExecutionContextLibrary_Prototype_ThreadSafeAnimNodeCall Parms{};
...
// Function AnimGraphRuntime.AnimExecutionContextLibrary.Prototype_ThreadSafeAnimUpdateCall
// (Final, Native, Public, HasOutParams, EditorOnly)
// Parameters:
// struct FAnimUpdateContext               Context                                                (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct FAnimNodeReference               Node                                                   (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)

void UAnimExecutionContextLibrary::Prototype_ThreadSafeAnimUpdateCall(const struct FAnimUpdateContext& Context, const struct FAnimNodeReference& Node)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AnimExecutionContextLibrary", "Prototype_ThreadSafeAnimUpdateCall");

	Params::AnimExecutionContextLibrary_Prototype_ThreadSafeAnimUpdateCall Parms{};
