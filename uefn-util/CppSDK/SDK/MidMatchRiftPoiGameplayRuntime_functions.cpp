...
// Parameters:
// int32                                   DataLayerInfoIndex                                     (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UMidmatchRiftPoiCheatManager::MidmatchRiftPoiSpawnFurthestFromPawnLocation(const int32 DataLayerInfoIndex)
{
	...
	Params::MidmatchRiftPoiCheatManager_MidmatchRiftPoiSpawnFurthestFromPawnLocation Parms{};

	Parms.DataLayerInfoIndex = DataLayerInfoIndex;
...
void UMidmatchRiftPoiCheatManager::MidmatchRiftPoiSpawnNearestToPawnLocation(const int32 DataLayerInfoIndex)
{
	static class UFunction* Func = nullptr;
	...
	Params::MidmatchRiftPoiCheatManager_MidmatchRiftPoiSpawnNearestToPawnLocation Parms{};
...
void UMidmatchRiftPoiCheatManager::SpawnMidmatchPoiFurthestLocation(const struct FVector& Location, const int32 DataLayerInfoIndex)
{
	static class UFunction* Func = nullptr;
...
void UMidmatchRiftPoiCheatManager::SpawnMidmatchPoiNearestLocation(const struct FVector& Location, const int32 DataLayerInfoIndex)
{
	static class UFunction* Func = nullptr;
