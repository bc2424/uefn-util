...
// Function AudioExtensions.AudioPropertiesSheetAssetBase.CopyToObjectProperties
// (Native, Public, BlueprintCallable, EditorOnly, Const)
// Parameters:
...
bool UAudioPropertiesSheetAssetBase::CopyToObjectProperties(class UObject* TargetObject) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AudioPropertiesSheetAssetBase", "CopyToObjectProperties");

	Params::AudioPropertiesSheetAssetBase_CopyToObjectProperties Parms{};
