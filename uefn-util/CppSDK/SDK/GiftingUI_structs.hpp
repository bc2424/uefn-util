...
{
public:
	struct FCatalogItemPrice                      Price;                                             // 0x0000(0x0058)(NativeAccessSpecifierPublic)
	TArray<struct FItemQuantity>                  Items;                                             // 0x0058(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
