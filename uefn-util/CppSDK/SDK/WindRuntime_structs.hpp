...
{
public:
	struct FVector                                Force;                                             // 0x00C0(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCurveFloat*                            StrengthOverTime;                                  // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<struct FWindSplineTargetDatum>         Items;                                             // 0x0110(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
{
public:
	struct FScalableFloat                         ForwardForceMagnitudeMultiplier;                   // 0x0000(0x0038)(Edit, NativeAccessSpecifierPublic)
	struct FScalableFloat                         ReverseForceMagnitudeMultiplier;                   // 0x0038(0x0038)(Edit, NativeAccessSpecifierPublic)
	struct FScalableFloat                         InwardForceOuterRadiusAccelerationMultiplier;      // 0x0070(0x0038)(Edit, NativeAccessSpecifierPublic)
	struct FScalableFloat                         InwardForceInnerRadiusDecelerationMultiplier;      // 0x00A8(0x0038)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FWindSplineForceModifiers              Modifier;                                          // 0x0048(0x00E0)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FGameplayTag                           Cue;                                               // 0x0048(0x000C)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_54[0x4];                                       // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TSubclassOf<class UGameplayEffect>>    GameplayEffects;                                   // 0x0058(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<struct FWindSplineBlockage>            Items;                                             // 0x0110(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
