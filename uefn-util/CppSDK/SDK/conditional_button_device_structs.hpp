...
// VerseStruct conditional_button_device.tuple_L_R
// 0x0001 (0x0001 - 0x0000)
struct conditional_button_device::Ftuple_L_R final
{
public:
	uint8                                         _StructPaddingDummy;                               // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// VerseStruct conditional_button_device.tuple_Lagent_Mint_R
// 0x0010 (0x0010 - 0x0000)
struct conditional_button_device::Ftuple_Lagent_Mint_R final
{
public:
...
// VerseStruct conditional_button_device.tuple_Lint_Mint_R
// 0x0010 (0x0010 - 0x0000)
struct conditional_button_device::Ftuple_Lint_Mint_R final
{
public:
