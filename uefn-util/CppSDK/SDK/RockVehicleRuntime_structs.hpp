...
{
public:
	float                                         CachedValue;                                       // 0x0038(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	struct FBoneReference                         ChassisBone;                                       // 0x01A0(0x0014)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FBouncyChassisState                    BouncyChassis;                                     // 0x01B4(0x000C)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FRockScalableFloat                     VelocityChange;                                    // 0x0000(0x0040)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FRockScalableFloat                     MaxSpeedScale;                                     // 0x0040(0x0040)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FRockScalableFloat                     DriveAccel;                                        // 0x0000(0x0040)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FRockScalableFloat                     DriveTopSpeed;                                     // 0x0040(0x0040)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FRockScalableFloat                     BrakeAccel;                                        // 0x0080(0x0040)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FRockScalableFloat                     StopSpeed;                                         // 0x00C0(0x0040)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	float                                         IdleBrakeFactor;                                   // 0x0100(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_104[0x4];                                      // 0x0104(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRuntimeFloatCurve                     DriveAccelCurve;                                   // 0x0108(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     SteerAngleCurve;                                   // 0x0190(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     LatFrictionCurve;                                  // 0x0218(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     LongFrictionCurve;                                 // 0x02A0(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     WallFrictionCurve;                                 // 0x0328(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     HandbrakeSteerAngleCurve;                          // 0x03B0(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     HandbrakeLatFrictionCurve;                         // 0x0438(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                     HandbrakeLongFrictionCurve;                        // 0x04C0(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FRockThrottledValue                    HandbrakeRate;                                     // 0x0548(0x0008)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
