...
// Function DelMarTrackRuntime.DelMarTrackBase.GetNextSplineSegmentIndexWithActor
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// int32                                   SplineSegmentIndex                                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int32                                   ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

int32 ADelMarTrackBase::GetNextSplineSegmentIndexWithActor(int32 SplineSegmentIndex) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DelMarTrackBase", "GetNextSplineSegmentIndexWithActor");

	Params::DelMarTrackBase_GetNextSplineSegmentIndexWithActor Parms{};

	Parms.SplineSegmentIndex = SplineSegmentIndex;
...
// Function DelMarTrackRuntime.DelMarTrack.GenerateOOBTube
// (Final, Native, Public, EditorOnly)

void ADelMarTrack::GenerateOOBTube()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DelMarTrack", "GenerateOOBTube");
...
// Function DelMarTrackRuntime.DelMarTrack.GetPrimaryLength
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// float                                   ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

float ADelMarTrack::GetPrimaryLength() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DelMarTrack", "GetPrimaryLength");

	Params::DelMarTrack_GetPrimaryLength Parms{};
...
// Function DelMarTrackRuntime.DelMarTrack.GetSecondaryDistance
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// float                                   DistanceOnPrimaryTrack                                 (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

float ADelMarTrack::GetSecondaryDistance(const float DistanceOnPrimaryTrack) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DelMarTrack", "GetSecondaryDistance");

	Params::DelMarTrack_GetSecondaryDistance Parms{};

	Parms.DistanceOnPrimaryTrack = DistanceOnPrimaryTrack;
...
// Function DelMarTrackRuntime.DelMarTrackPalette.UpdateMappingArrays
// (Final, Native, Public, BlueprintCallable, EditorOnly)

void UDelMarTrackPalette::UpdateMappingArrays()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DelMarTrackPalette", "UpdateMappingArrays");
