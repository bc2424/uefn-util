...
{
public:
	struct FAudioAnalysisParameterScalar          Param;                                             // 0x0000(0x00C0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
...
{
public:
	struct FAudioAnalysisParameterVector          Param;                                             // 0x0000(0x00D0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
...
public:
	...
	struct FAudioAnalysisParameterScalar          K2Node_Event_Param_1;                              // 0x0020(0x00C0)(ConstParm)
	class UWB_AudioAnalysis_FloatGraph_C*         CallFunc_Array_Get_Item;                           // 0x00E0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	struct FAudioAnalysisParameterVector          K2Node_Event_Param;                                // 0x00F0(0x00D0)(ConstParm)
	...
	class UWB_AudioAnalysis_FloatGraph_C*         CallFunc_Create_ReturnValue;                       // 0x01C8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UWB_AudioAnalysis_FloatGraph_C*         CallFunc_Create_ReturnValue_1;                     // 0x01D0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UVerticalBoxSlot*                       CallFunc_AddChildToVerticalBox_ReturnValue;        // 0x01D8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
