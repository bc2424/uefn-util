...
{
public:
	TWeakObjectPtr<class AController>             Controller;                                        // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	TMap<TWeakObjectPtr<class AController>, class UVerseAgent*> TrackedAgents;                                     // 0x0038(0x0050)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
