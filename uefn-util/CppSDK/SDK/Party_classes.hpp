...
public:
	...
	TArray<class USocialToolkit*>                 SocialToolkits;                                    // 0x00B0(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	class USocialDebugTools*                      SocialDebugTools;                                  // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	class USocialChatManager*                     SocialChatManager;                                 // 0x0080(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class USocialUser*                            LocalUser;                                         // 0x0088(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class USocialUser*>                    AllUsers;                                          // 0x0090(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_A0[0x50];                                      // 0x00A0(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bRemoveInvalidatedUserFromMaps;                    // 0x00F0(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_F1[0x3];                                       // 0x00F1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class ULocalPlayer>            LocalPlayerOwner;                                  // 0x00F4(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_FC[0x1E4];                                     // 0x00FC(0x01E4)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	uint8                                         Pad_30[0x50];                                      // 0x0030(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<TWeakObjectPtr<class USocialUser>, class USocialPrivateMessageChannel*> DirectChannelsByTargetUser;                        // 0x0080(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TMap<class FString, class USocialChatRoom*>   ChatRoomsById;                                     // 0x00D0(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TMap<class FString, class USocialReadOnlyChatChannel*> ReadOnlyChannelsByDisplayName;                     // 0x0120(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	bool                                          bEnableChatSlashCommands;                          // 0x0170(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_171[0x7];                                      // 0x0171(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FUniqueNetIdRepl, class USocialGroupChannel*> GroupChannels;                                     // 0x0178(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
public:
	...
	class FText                                   DisplayName;                                       // 0x0068(0x0010)(NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                         Pad_264[0x10C];                                    // 0x0264(0x010C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	class USocialUser*                            DefaultSocialUser;                                 // 0x0078(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_80[0x1];                                       // 0x0080(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bEnableDebugInitializer;                           // 0x0081(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_82[0x9E];                                      // 0x0082(0x009E)(Fixing Struct Size After Last Property [ Dumper-7 ])
