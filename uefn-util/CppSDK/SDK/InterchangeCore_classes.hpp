...
{
public:
	class FString                                 DestinationName;                                   // 0x0030(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ContentImportPath;                                 // 0x0040(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_50[0x3];                                       // 0x0050(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bFromReimportOrOverride;                           // 0x0053(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_54[0x4];                                       // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UInterchangeResultsContainer*           Results;                                           // 0x0058(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TMap<class FName, struct FInterchangePipelinePropertyStates> PropertiesStates;                                  // 0x0060(0x0050)(Protected, NativeAccessSpecifierProtected)
...
public:
	...
	class FString                                 AssetFriendlyName;                                 // 0x0050(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UObject>                    AssetType;                                         // 0x0060(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 InterchangeKey;                                    // 0x0068(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	class FText                                   Text;                                              // 0x0078(0x0010)(NativeAccessSpecifierPublic)
...
{
public:
	EInterchangeNodeUserInterfaceContext          UserInterfaceContext;                              // 0x0030(0x0001)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, EditorOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_31[0x3F];                                      // 0x0031(0x003F)(Fixing Struct Size After Last Property [ Dumper-7 ])
