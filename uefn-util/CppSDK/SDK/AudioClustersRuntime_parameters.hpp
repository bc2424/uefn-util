...
{
public:
	struct FAudioClusterActorInfo                 ActorInfo;                                         // 0x0000(0x0014)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	struct FAudioClusterOneShotInfo               OneShotInfo;                                       // 0x0000(0x0030)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
