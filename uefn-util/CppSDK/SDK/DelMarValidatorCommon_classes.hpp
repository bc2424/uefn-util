...
class IDelMarValidatorInterface final : public IInterface
{
public:
...
public:
	...
	class UWorld*                                 DelMarWorld;                                       // 0x0038(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
