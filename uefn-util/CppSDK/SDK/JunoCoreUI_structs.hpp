...
// Enum JunoCoreUI.EJunoUserGeneratedTextErrorType
// NumValues: 0x000A
enum class EJunoUserGeneratedTextErrorType : uint8
{
	None                                     = 0,
	NameAlreadyUsed                          = 1,
	NameNotSupported                         = 2,
...
{
public:
	TSoftObjectPtr<class UTexture2D>              WorldImage;                                        // 0x0008(0x0030)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
