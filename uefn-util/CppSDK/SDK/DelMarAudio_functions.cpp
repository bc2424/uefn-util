...
// Function DelMarAudio.DelMarRaceMusicManager.TryGetFortClientSettings
// (Final, Native, Protected)

void UDelMarRaceMusicManager::TryGetFortClientSettings()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DelMarRaceMusicManager", "TryGetFortClientSettings");
