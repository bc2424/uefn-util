...
{
public:
	struct FScalableFloat                         Range;                                             // 0x0000(0x0038)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         OffsetFromTarget;                                  // 0x0038(0x0038)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FFortAbilityTargetSelectionList        TargetSelectionList;                               // 0x0070(0x0048)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
