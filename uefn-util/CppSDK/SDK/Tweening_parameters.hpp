...
public:
	...
	class FName                                   ParameterName;                                     // 0x0018(0x000C)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTweenOptionalLinearColor              FromOptions;                                       // 0x0024(0x0014)(Parm, NoDestructor, NativeAccessSpecifierPublic)
	struct FLinearColor                           ToValue;                                           // 0x0038(0x0010)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FTweenDelayOptions                     DelayOptions;                                      // 0x004C(0x000C)(Parm, NoDestructor, NativeAccessSpecifierPublic)
	ETweenBuiltInEasing                           EasingFunction;                                    // 0x0058(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_59[0x7];                                       // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UCurveFloat*                            EasingCurve;                                       // 0x0060(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTweenLoopOptions                      LoopOptions;                                       // 0x0068(0x0008)(Parm, NoDestructor, NativeAccessSpecifierPublic)
	...
	bool                                          bAutoKill;                                         // 0x0071(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
