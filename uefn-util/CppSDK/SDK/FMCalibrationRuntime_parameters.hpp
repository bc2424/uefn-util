...
struct FMCalibrationControllerComponent_SetCalibrometerDisplay final
{
public:
	bool                                          bCalibrometerDisplay;                              // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct FMCalibrationControllerComponent_SendCalibrationAnalytics final
{
public:
	const class AFortPlayerController*            AuthoritativePlayer;                               // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
