...
// Parameters:
// TScriptInterface<class IMetaSoundDocumentInterface>DocInterface                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UMetaSoundAssetSubsystem::ReassignClassName(TScriptInterface<class IMetaSoundDocumentInterface> DocInterface)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MetaSoundAssetSubsystem", "ReassignClassName");

	Params::MetaSoundAssetSubsystem_ReassignClassName Parms{};

	Parms.DocInterface = DocInterface;
...
// Parameters:
// TArray<struct FMetaSoundAssetDirectory> InDirectories                                          (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
// struct FMetasoundFrontendClassName      OldClassName                                           (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FMetasoundFrontendClassName      NewClassName                                           (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FMetasoundFrontendVersionNumber  OldVersion                                             (ConstParm, Parm, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FMetasoundFrontendVersionNumber  NewVersion                                             (ConstParm, Parm, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool UMetaSoundAssetSubsystem::ReplaceReferencesInDirectory(const TArray<struct FMetaSoundAssetDirectory>& InDirectories, const struct FMetasoundFrontendClassName& OldClassName, const struct FMetasoundFrontendClassName& NewClassName, const struct FMetasoundFrontendVersionNumber& OldVersion, const struct FMetasoundFrontendVersionNumber& NewVersion)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("MetaSoundAssetSubsystem", "ReplaceReferencesInDirectory");

	Params::MetaSoundAssetSubsystem_ReplaceReferencesInDirectory Parms{};

	Parms.InDirectories = std::move(InDirectories);
	Parms.OldClassName = std::move(OldClassName);
...
// (Final, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct FMetasoundFrontendClassName      ClassName_0                                            (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EMetaSoundBuilderResult                 OutResult                                              (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FMetaSoundNodeHandle UMetaSoundBuilderBase::AddNodeByClassName(const struct FMetasoundFrontendClassName& ClassName_0, EMetaSoundBuilderResult* OutResult, int32 MajorVersion)
{
	static class UFunction* Func = nullptr;
	...
	Parms.ClassName_0 = std::move(ClassName_0);
...
// struct FMetaSoundNodeHandle             NodeHandle                                             (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
// EMetaSoundBuilderResult                 OutResult                                              (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    bRemoveUnusedDependencies                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
