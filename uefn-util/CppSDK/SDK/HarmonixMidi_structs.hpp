...
public:
	...
	struct FMusicTimestamp                        Timestamp;                                         // 0x0020(0x0008)(BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FTimeSignature                         TimeSignature;                                     // 0x0010(0x0004)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FMidiMsg                               Message;                                           // 0x0004(0x0004)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
public:
	...
	int32                                         TicksPerQuarterNote;                               // 0x0008(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTempoMap                              TempoMap;                                          // 0x0010(0x0020)(Protected, NativeAccessSpecifierProtected)
	struct FBarMap                                BarMap;                                            // 0x0030(0x0018)(Protected, NativeAccessSpecifierProtected)
	struct FBeatMap                               BeatMap;                                           // 0x0048(0x0028)(Protected, NativeAccessSpecifierProtected)
	struct FSectionMap                            SectionMap;                                        // 0x0070(0x0018)(Protected, NativeAccessSpecifierProtected)
	struct FChordProgressionMap                   ChordMap;                                          // 0x0088(0x0020)(Protected, NativeAccessSpecifierProtected)
	TArray<class FString>                         TrackNames;                                        // 0x00A8(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	struct FSongLengthData                        LengthData;                                        // 0x00B8(0x000C)(NoDestructor, NativeAccessSpecifierPrivate)
...
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 MidiFileName;                                      // 0x0008(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TicksPerQuarterNote;                               // 0x0018(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSongMaps                              SongMaps;                                          // 0x0020(0x00C8)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	TArray<struct FMidiTrack>                     Tracks;                                            // 0x00E8(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
};
