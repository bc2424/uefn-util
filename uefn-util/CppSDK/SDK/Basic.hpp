...
namespace Offsets
{
	constexpr int32 GObjects          = 0x37EA61A0;
	constexpr int32 AppendString      = 0x0D301280;
	constexpr int32 GNames            = 0x382C8900;
	constexpr int32 GWorld            = 0x38220C70;
	constexpr int32 ProcessEvent      = 0x01DBD7E0;
	constexpr int32 ProcessEventIdx   = 0x00000072;
}
...
public:
	...
	inline class FUObjectItem* GetObjByIndex(const int32 Index) const
	{
		const int32 ChunkIndex = Index / ElementsPerChunk;
		const int32 InChunkIdx = Index % ElementsPerChunk;
...
public:
	...
	TArray<FName>                                 Path;                                              // 0x0020(0x0010)(NOT AUTO-GENERATED PROPERTY)
};
...
public:
	...
	class FProperty*                              InnerProperty;                                     // 0x0090(0x0008)(NOT AUTO-GENERATED PROPERTY)
};
