...
{
public:
	struct FClamberMontageInput                   Context;                                           // 0x0000(0x0060)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
	class UAnimMontage*                           AnimMontage;                                       // 0x0060(0x0008)(Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   StartSectionName;                                  // 0x0068(0x000C)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   MontageMiddleSectionName;                          // 0x0074(0x000C)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FSynchedActionInfo                     SynchedActionInfo;                                 // 0x0000(0x0040)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
...
// Function ClamberingCodeRuntime.ClamberingComponent.HandleOwnerPersonalVehicleModeChanged
// 0x0001 (0x0001 - 0x0000)
struct ClamberingComponent_HandleOwnerPersonalVehicleModeChanged final
{
public:
	bool                                          bIsMounted;                                        // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FClamberingTargetingData               TargetingData;                                     // 0x0000(0x00E8)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FReplicatedClamberingTargetingData     InReplicatedTargetingData;                         // 0x0000(0x0080)(ConstParm, Parm, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	double                                        ClientLastTeleportTime;                            // 0x0080(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FClamberingTargetingData               OutTargetingData;                                  // 0x0008(0x00E8)(Parm, OutParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
