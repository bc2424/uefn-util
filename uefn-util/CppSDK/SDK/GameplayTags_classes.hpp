...
public:
	...
	TMap<class FName, struct FGameplayTagSource>  TagSources;                                        // 0x01F0(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_240[0x160];                                    // 0x0240(0x0160)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UDataTable*>                     GameplayTagTables;                                 // 0x03A0(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
...
public:
	...
	bool                                          ClearInvalidTags;                                  // 0x0052(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class FString                                 NewTagSource;                                      // 0x00D0(0x0010)(Edit, ZeroConstructor, Transient, EditorOnly, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 CleanupUnusedTags;                                 // 0x00E0(0x0010)(Edit, ZeroConstructor, Transient, EditorOnly, HasGetValueTypeHash, NativeAccessSpecifierPublic)
