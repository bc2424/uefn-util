...
public:
	...
	TArray<struct FUIFrameworkWidgetTreeEntry>    Entries;                                           // 0x0140(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	class AActor*                                 ReplicatedOwner;                                   // 0x0150(0x0008)(ZeroConstructor, Transient, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_158[0xA8];                                     // 0x0158(0x00A8)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	TArray<struct FUIFrameworkGameLayerSlot>      Entries;                                           // 0x0110(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	class UUIFrameworkPlayerComponent*            Owner;                                             // 0x0120(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
{
public:
	TArray<struct FUIFrameworkCanvasBoxSlot>      Slots;                                             // 0x0110(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	class UUIFrameworkCanvasBox*                  Owner;                                             // 0x0120(0x0008)(ZeroConstructor, Transient, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
public:
	...
	TSoftObjectPtr<class UObject>                 ResourceObject;                                    // 0x0010(0x0030)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2f                              DesiredSize;                                       // 0x0040(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESlateBrushTileType                           Tiling;                                            // 0x0048(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseTextureSize;                                   // 0x0049(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	TArray<struct FUIFrameworkOverlaySlot>        Slots;                                             // 0x0110(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	class UUIFrameworkOverlay*                    Owner;                                             // 0x0120(0x0008)(ZeroConstructor, Transient, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
{
public:
	TArray<struct FUIFrameworkStackBoxSlot>       Slots;                                             // 0x0110(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	class UUIFrameworkStackBox*                   Owner;                                             // 0x0120(0x0008)(ZeroConstructor, Transient, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
{
public:
	class FName                                   SlotName;                                          // 0x0028(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	TArray<struct FUIFrameworkUserWidgetNamedSlot> Slots;                                             // 0x0110(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	class UUIFrameworkUserWidget*                 Owner;                                             // 0x0120(0x0008)(ZeroConstructor, Transient, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
