...
{
public:
	TDelegate<void(class AActor* OtherActor)>     InEvent;                                           // 0x0000(0x0014)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// Function FNE_VolumeRuntime.FNE_VolumeOverlapComponent.ComponentAddedToMinigame
// 0x0008 (0x0008 - 0x0000)
struct FNE_VolumeOverlapComponent_ComponentAddedToMinigame final
{
public:
...
{
public:
	TSoftObjectPtr<class UMaterialInterface>      MaterialToLoad;                                    // 0x0000(0x0030)(Parm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ElementIndex;                                      // 0x0030(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
