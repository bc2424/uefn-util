...
{
public:
	class UDeltaFileSaveHandler*                  SaveHandler;                                       // 0x0030(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	TMap<class UWorld*, struct FDeltaTrackingHandles> WorldToTrackingHandles;                            // 0x0038(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TMap<class FName, class UObject*>             DeltaFiles;                                        // 0x0088(0x0050)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	struct FSoftClassPath                         DefaultDeltaFileClass;                             // 0x00D8(0x0028)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	class FString                                 PackageToApplyTo;                                  // 0x0038(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<struct FGuid, struct FAddAction>         AddActions;                                        // 0x0048(0x0050)(NativeAccessSpecifierPublic)
	TArray<struct FUpdateAction>                  UpdateActions;                                     // 0x0098(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<struct FGuid, struct FDeleteAction>      DeleteActions;                                     // 0x00A8(0x0050)(NativeAccessSpecifierPublic)
