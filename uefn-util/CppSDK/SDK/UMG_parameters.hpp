...
{
public:
	struct FButtonStyle                           InStyle;                                           // 0x0000(0x0420)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FSlateFontInfo                         InFontInfo;                                        // 0x0000(0x0070)(Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FSlateFontInfo                         ReturnValue;                                       // 0x0000(0x0070)(ConstParm, Parm, OutParm, ReturnParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
