...
{
public:
	class UMediaSource*                           MediaSource;                                       // 0x0040(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	struct FMovieSceneObjectBindingID             MediaSourceProxy;                                  // 0x0010(0x001C)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MediaSourceProxyIndex;                             // 0x002C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FMovieSceneFloatChannel                ProxyTextureBlend;                                 // 0x0050(0x0118)(NativeAccessSpecifierPublic)
	struct FMediaSourceCacheSettings              CacheSettings;                                     // 0x0168(0x0008)(NoDestructor, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FMovieSceneMediaSectionParams          Params;                                            // 0x0020(0x0170)(ContainsInstancedReference, NativeAccessSpecifierPrivate)
	class UMovieSceneMediaSection*                MediaSection;                                      // 0x0190(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
