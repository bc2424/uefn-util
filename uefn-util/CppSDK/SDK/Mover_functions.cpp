...
TArray<class FString> UMoverComponent::GetStartingMovementModeNames()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MoverComponent", "GetStartingMovementModeNames");

	Params::MoverComponent_GetStartingMovementModeNames Parms{};
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// const class UBaseMovementMode*          ReturnValue                                            (ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FRotator ITurnGeneratorInterface::GetTurn(const struct FRotator& TargetOrientation, const struct FMoverTickStartData& FullStartState, const struct FMoverDefaultSyncState& MoverState, const struct FMoverTimeStep& TimeStep, const struct FProposedMove& ProposedMove, class UMoverBlackboard* SimBlackboard)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("TurnGeneratorInterface", "GetTurn");
...
void IMoverInputProducerInterface::ProduceInput(int32 SimTimeMs, struct FMoverInputCmdContext* InputCmdResult)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("MoverInputProducerInterface", "ProduceInput");
...
// Function Mover.BaseMovementMode.K2_OnActivate
// (Event, Protected, BlueprintEvent)

void UBaseMovementMode::K2_OnActivate()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BaseMovementMode", "K2_OnActivate");

	UObject::ProcessEvent(Func, nullptr);
}


// Function Mover.BaseMovementMode.K2_OnDeactivate
// (Event, Protected, BlueprintEvent)

void UBaseMovementMode::K2_OnDeactivate()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BaseMovementMode", "K2_OnDeactivate");
