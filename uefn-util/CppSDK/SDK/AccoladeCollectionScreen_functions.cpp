...
// (Event, Protected, BlueprintEvent)
// Parameters:
// bool                                    bPinned                                                (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// bool                                    bShouldBeSuppressed                                    (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// Function AccoladeCollectionScreen.FortPlayerAccoladeCollectionScreenInfoOverlay.BP_PopulateProductCompatibility
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
// bool                                    bIsCurrentlyCompatible                                 (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FGameplayTagQuery                ProductCompatibilityQuery                              (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct FGameplayTagContainer            AdditionalQueryTags                                    (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void UFortPlayerAccoladeCollectionScreenInfoOverlay::BP_PopulateProductCompatibility(const bool bIsCurrentlyCompatible, const struct FGameplayTagQuery& ProductCompatibilityQuery, const struct FGameplayTagContainer& AdditionalQueryTags)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortPlayerAccoladeCollectionScreenInfoOverlay", "BP_PopulateProductCompatibility");

	Params::FortPlayerAccoladeCollectionScreenInfoOverlay_BP_PopulateProductCompatibility Parms{};

	Parms.bIsCurrentlyCompatible = bIsCurrentlyCompatible;
	Parms.ProductCompatibilityQuery = std::move(ProductCompatibilityQuery);
	Parms.AdditionalQueryTags = std::move(AdditionalQueryTags);
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// bool                                    bTracked                                               (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
