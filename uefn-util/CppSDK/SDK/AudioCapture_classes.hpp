...
{
public:
	int32                                         JitterLatencyFrames;                               // 0x0920(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_924[0xBC];                                     // 0x0924(0x00BC)(Fixing Struct Size After Last Property [ Dumper-7 ])
