...
struct MidmatchRiftPoiCheatManager_MidmatchRiftPoiSpawnFurthestFromPawnLocation final
{
public:
	int32                                         DataLayerInfoIndex;                                // 0x0000(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};

// Function MidMatchRiftPoiGameplayRuntime.MidmatchRiftPoiCheatManager.MidmatchRiftPoiSpawnNearestToPawnLocation
// 0x0004 (0x0004 - 0x0000)
struct MidmatchRiftPoiCheatManager_MidmatchRiftPoiSpawnNearestToPawnLocation final
{
public:
	int32                                         DataLayerInfoIndex;                                // 0x0000(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	int32                                         DataLayerInfoIndex;                                // 0x0018(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FSlateBrush                            LandIcon;                                          // 0x0000(0x00D0)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
