...
struct alignas(0x10) FMovieSceneConstraintChannel final : public FMovieSceneBoolChannel
{
public:
...
{
public:
	struct FMovieSceneConstraintChannel           ActiveChannel;                                     // 0x0000(0x0150)(NativeAccessSpecifierPublic)
	class UTickableConstraint*                    ConstraintCopyToSpawn;                             // 0x0150(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
