...
public:
	...
	uint8                                         Pad_14[0x154];                                     // 0x0014(0x0154)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FRigVMByteCodeEntry>            Entries;                                           // 0x0168(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FRigVMBranchInfo>               BranchInfos;                                       // 0x0178(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FRigVMPredicateBranch>          PredicateBranches;                                 // 0x0188(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	class FString                                 PublicContextPathName;                             // 0x0198(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	struct FRigVMByteCode                         ByteCode;                                          // 0x0000(0x0200)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FName>                           FunctionNames;                                     // 0x0200(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyDescription> WorkPropertyDescriptions;                          // 0x0210(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyPath> WorkPropertyPathDescriptions;                      // 0x0220(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyDescription> LiteralPropertyDescriptions;                       // 0x0230(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyPath> LiteralPropertyPathDescriptions;                   // 0x0240(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyDescription> DebugPropertyDescriptions;                         // 0x0250(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyPath> DebugPropertyPathDescriptions;                     // 0x0260(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyDescription> ExternalPropertyDescriptions;                      // 0x0270(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyPath> ExternalPropertyPathDescriptions;                  // 0x0280(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<int32, class FName>                      ExternalRegisterIndexToVariable;                   // 0x0290(0x0050)(NativeAccessSpecifierPublic)
	TMap<class FString, struct FRigVMOperand>     Operands;                                          // 0x02E0(0x0050)(NativeAccessSpecifierPublic)
	uint32                                        Hash;                                              // 0x0330(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEncounteredSurpressedErrors;                      // 0x0334(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_335[0x53];                                     // 0x0335(0x0053)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	struct FRigVMGraphFunctionHeader              Header;                                            // 0x0000(0x0160)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRigVMFunctionCompilationData          CompilationData;                                   // 0x0160(0x0388)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 SerializedCollapsedNode;                           // 0x04E8(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	class URigVMMemoryStorage*                    WorkMemoryStorageObject;                           // 0x00B0(0x0008)(ZeroConstructor, Transient, Deprecated, EditorOnly, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class URigVMMemoryStorage*                    DebugMemoryStorageObject;                          // 0x00B8(0x0008)(ZeroConstructor, Transient, Deprecated, EditorOnly, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C0[0x1D8];                                     // 0x00C0(0x01D8)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	bool                                          bEnableProfiling;                                  // 0x0004(0x0001)(Edit, ZeroConstructor, IsPlainOldData, EditorOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// 0x0010 (0x0018 - 0x0008)
struct FRigVMTrait final : public FRigVMStruct
{
public:
...
// 0x0048 (0x0048 - 0x0000)
struct alignas(0x08) FRigVMVariantRef final
{
public:
...
public:
	...
	class FName                                   BaseCPPType;                                       // 0x0028(0x000C)(ZeroConstructor, Transient, IsPlainOldData, EditorOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                BaseCPPTypeObject;                                 // 0x0038(0x0008)(ZeroConstructor, Transient, EditorOnly, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
