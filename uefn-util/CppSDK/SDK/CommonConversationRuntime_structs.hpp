...
{
public:
	struct FGameplayTag                           SpeakerID;                                         // 0x0000(0x000C)(BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   ParticipantDisplayName;                            // 0x0010(0x0010)(BlueprintVisible, NativeAccessSpecifierPublic)
	class FText                                   Text;                                              // 0x0020(0x0010)(BlueprintVisible, NativeAccessSpecifierPublic)
	TArray<struct FConversationNodeParameterPair> MetadataParameters;                                // 0x0030(0x0010)(BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FGameplayTag                           ParticipantID;                                     // 0x0008(0x000C)(BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FClientConversationMessage             Message;                                           // 0x0000(0x0040)(BlueprintVisible, NativeAccessSpecifierPublic)
	struct FConversationParticipants              Participants;                                      // 0x0040(0x0010)(BlueprintVisible, NativeAccessSpecifierPublic)
	struct FConversationNodeHandle                CurrentNode;                                       // 0x0050(0x0010)(BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	TArray<struct FClientConversationOptionEntry> Options;                                           // 0x0060(0x0010)(BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FGameplayTag                           EntryTag;                                          // 0x0000(0x000C)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FGuid>                          DestinationList;                                   // 0x0010(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FClientConversationMessage             Message;                                           // 0x0038(0x0040)(NativeAccessSpecifierPrivate)
};
...
public:
	...
	struct FGameplayTag                           ParticipantName;                                   // 0x0010(0x000C)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
