...
void UWBP_UIKit_ButtonCTA_Base_C::IsHoldable(bool* Holdable)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UIKit_ButtonCTA_Base_C", "IsHoldable");

	Params::WBP_UIKit_ButtonCTA_Base_C_IsHoldable Parms{};
...
// (Protected, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    IsDark                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_UIKit_ButtonCTA_Base_C::Set_Icon_Dark_Mode(bool IsDark)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UIKit_ButtonCTA_Base_C", "Set Icon Dark Mode");

	Params::WBP_UIKit_ButtonCTA_Base_C_Set_Icon_Dark_Mode Parms{};
...
// (Protected, BlueprintCallable, BlueprintEvent)
// Parameters:
// class FText                             SecondaryText_0                                        (BlueprintVisible, BlueprintReadOnly, Parm)
...
void UWBP_UIKit_ButtonCTA_Base_C::ShouldPlayHoldSound(bool* Holdable)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UIKit_ButtonCTA_Base_C", "ShouldPlayHoldSound");

	Params::WBP_UIKit_ButtonCTA_Base_C_ShouldPlayHoldSound Parms{};
...
// Function WBP_UIKit_ButtonCTA_Base.WBP_UIKit_ButtonCTA_Base_C.Switch Input
// (BlueprintCallable, BlueprintEvent)

void UWBP_UIKit_ButtonCTA_Base_C::Switch_Input()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UIKit_ButtonCTA_Base_C", "Switch Input");
