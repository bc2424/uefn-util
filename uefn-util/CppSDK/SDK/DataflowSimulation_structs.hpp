...
// 0x0000 (0x0078 - 0x0078)
struct FDataflowCollisionObjectProxy final : public FDataflowPhysicsObjectProxy
{
};

// ScriptStruct DataflowSimulation.DataflowConstraintObjectProxy
// 0x0000 (0x0078 - 0x0078)
struct FDataflowConstraintObjectProxy final : public FDataflowPhysicsObjectProxy
{
};

// ScriptStruct DataflowSimulation.DataflowPhysicsSolverProxy
// 0x0000 (0x0078 - 0x0078)
struct FDataflowPhysicsSolverProxy final : public FDataflowSimulationProxy
{
};
...
{
public:
	struct FDataflowSimulationTime                SimulationTime;                                    // 0x01A0(0x0008)(Transient, NoDestructor, NativeAccessSpecifierPublic)
};
