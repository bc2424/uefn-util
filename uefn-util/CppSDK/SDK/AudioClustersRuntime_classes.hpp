...
{
public:
	class UAudioClusterBehavior*                  Behavior;                                          // 0x0030(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	TMap<struct FGameplayTag, class UAudioClusterConfig*> TagConfigMap;                                      // 0x0030(0x0050)(Edit, UObjectWrapper, NativeAccessSpecifierPublic)
