...
{
public:
	class FName                                   ComponentName;                                     // 0x000C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<struct FFastEntityComponentArrayItem>  Components;                                        // 0x0110(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
};
