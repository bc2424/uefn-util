...
public:
	...
	struct FVector_NetQuantize                    SoundLocation;                                     // 0x0038(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	TArray<struct FMusicSequencerHitEntry>        Items;                                             // 0x0110(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class UMusicSequencerHitComponent> OwningComponent;                                   // 0x0120(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
};
