...
void UFortGA_NitroBashBase::BP_TryChangeBashState(bool IsBashable)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FortGA_NitroBashBase", "BP_TryChangeBashState");
...
void UFortGA_NitroBashBase::SpeedCheck()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FortGA_NitroBashBase", "SpeedCheck");
...
float UFortGA_NitroBashBase::GetOwnerSpeed() const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FortGA_NitroBashBase", "GetOwnerSpeed");
