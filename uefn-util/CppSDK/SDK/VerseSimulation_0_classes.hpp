...
{
public:
	static TOptional<class UEntityComponent*, true> _L_2fVerse_2eorg_2fSimulation_N_RGetComponentOfTypeForPlayer_L_Nint_M_NType_20where_20Type_R(const struct Ftuple_Lint_Msupertype_Lany_R_R& __verse_0xB2CDDD72_Argument);
	static TOptional<class UEntityComponent*, true> _L_2fVerse_2eorg_2fSimulation_N_RGetComponentOfTypeForPlayer_L_Nplayer__component_M_NType_20where_20Type_R(const struct Ftuple_Lplayer__component_Msupertype_Lany_R_R& __verse_0xB2CDDD72_Argument);
	static TOptional<class UEntityComponent*, true> _L_2fVerse_2eorg_2fSimulation_N_RGetOrCreateComponentOfTypeForPlayer_L_Nint_M_NType_20where_20Type_R(const struct Ftuple_Lint_Msupertype_Lany_R_R& __verse_0xB2CDDD72_Argument);
	static TOptional<class UEntityComponent*, true> _L_2fVerse_2eorg_2fSimulation_N_RGetOrCreateComponentOfTypeForPlayer_L_Nplayer__component_M_NType_20where_20Type_R(const struct Ftuple_Lplayer__component_Msupertype_Lany_R_R& __verse_0xB2CDDD72_Argument);
...
{
public:
	class USimulation_agent*                      __verse_0x31A8F10C_Value;                          // 0x0030(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
{
public:
	double                                        __verse_0xB2CDDD72_Argument;                       // 0x00C8(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
