...
// Function SlidingRuntime.FortPawnComponent_SlidingProvider.EventCallback_OnPawnControllerChanged
// (Final, Native, Private)
// Parameters:
...
void UFortPawnComponent_SlidingProvider::EventCallback_OnPawnControllerChanged(class APawn* Pawn, class AController* OldController, class AController* NewController)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortPawnComponent_SlidingProvider", "EventCallback_OnPawnControllerChanged");

	Params::FortPawnComponent_SlidingProvider_EventCallback_OnPawnControllerChanged Parms{};
...
// (Final, Native, Private)
// Parameters:
// bool                                    bIsPawnSliding                                         (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// Function SlidingRuntime.FortPawnComponent_SlidingProvider.CanPlayerProceedToSliding
// (Native, Public, Const)
// Parameters:
...
bool UFortPawnComponent_SlidingProvider::CanPlayerProceedToSliding(bool bPrintLog) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortPawnComponent_SlidingProvider", "CanPlayerProceedToSliding");

	Params::FortPawnComponent_SlidingProvider_CanPlayerProceedToSliding Parms{};
