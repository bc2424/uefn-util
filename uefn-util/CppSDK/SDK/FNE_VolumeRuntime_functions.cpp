...
void UFNE_VolumeOverlapComponent::ComponentAddedToMinigame(class AFortMinigame* Minigame)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FNE_VolumeOverlapComponent", "ComponentAddedToMinigame");

	Params::FNE_VolumeOverlapComponent_ComponentAddedToMinigame Parms{};
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// EVolumeEnableOverlapBehavior            InOverlapBehavior                                      (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
