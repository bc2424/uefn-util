...
// Parameters:
// class ABuildingGameplayActor*           OwningTurretBGA                                        (ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FDeployableTurretBPAnimData      AnimData                                               (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
// TMap<struct FGameplayTag, struct FScalableFloat>NonPlayerPawnTargetTagToZOffsetMap                     (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
