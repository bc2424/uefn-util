...
{
public:
	class FName                                   SurfaceName;                                       // 0x0000(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FString>                         DevelopmentLinkCodes;                              // 0x0010(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
