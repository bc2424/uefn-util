...
public:
	...
	struct FScalableFloat                         TransitionDuration;                                // 0x0008(0x0038)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FGameplayTag                           DismissalReason;                                   // 0x0000(0x000C)(BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FGameplayTag                           Source;                                            // 0x0000(0x000C)(BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AActor*>                         MarkedActors;                                      // 0x0010(0x0010)(BlueprintVisible, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FGameplayTag                           DismissalReason;                                   // 0x0008(0x000C)(Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ServerDismissStartTime;                            // 0x0014(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class FName                                   InputActionName;                                   // 0x0000(0x000C)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FGameplayTag                           GameplayEventToTrigger;                            // 0x0018(0x000C)(Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FScalableFloat                         CapsuleHalfHeight;                                 // 0x0000(0x0038)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         CapsuleRadius;                                     // 0x0038(0x0038)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
