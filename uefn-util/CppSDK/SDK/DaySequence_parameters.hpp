...
public:
	...
	float                                         Key;                                               // 0x000C(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// 0x0004 (0x0004 - 0x0000)
struct ProceduralDaySequenceBuilder_AddStaticTime final
{
public:
	float                                         StaticTime;                                        // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};

// Function DaySequence.ProceduralDaySequenceBuilder.ClearScalarKeys
// 0x000C (0x000C - 0x0000)
struct ProceduralDaySequenceBuilder_ClearScalarKeys final
{
public:
	class FName                                   PropertyName;                                      // 0x0000(0x000C)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
