...
{
public:
	uint32                                        VerseClassFlags;                                   // 0x00E0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_E4[0x4];                                       // 0x00E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UFunction*                              InitFunction;                                      // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UObject>                    ModuleClass;                                       // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGuid                                  Guid;                                              // 0x00F8(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFunction*                              FactoryFunction;                                   // 0x0108(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFunction*                              OverrideFactoryFunction;                           // 0x0110(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVerseEffectSet                        ConstructorEffects;                                // 0x0118(0x0004)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_11C[0x4];                                      // 0x011C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UStructCookedMetaData*                  CachedCookedMetaDataPtr;                           // 0x0120(0x0008)(ZeroConstructor, EditorOnly, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	TArray<struct FVerseAssetConfig>              AssetConfigs;                                      // 0x0030(0x0010)(ZeroConstructor, Config, NativeAccessSpecifierPrivate)
...
{
public:
	TArray<uint8>                                 DigestCode;                                        // 0x0030(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<uint8>                                 ManifestCode;                                      // 0x0040(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FManifestDependency>            DependencyPackages;                                // 0x0050(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TSet<struct FSoftObjectPath>                  ClassImports;                                      // 0x0060(0x0050)(NativeAccessSpecifierPublic)
	class FString                                 ProjectName;                                       // 0x00B0(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EVerseDigestVariant                           Variant;                                           // 0x00C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C1[0x3];                                       // 0x00C1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        VerseVersion;                                      // 0x00C4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	class UEnumCookedMetaData*                    CachedCookedMetaDataPtr;                           // 0x0078(0x0008)(ZeroConstructor, EditorOnly, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	TArray<class FString>                         Blacklist;                                         // 0x0030(0x0010)(ZeroConstructor, Config, NativeAccessSpecifierPublic)
	int32                                         MaxAllowedSize;                                    // 0x0040(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	uint32                                        SolClassFlags;                                     // 0x0268(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_26C[0x4];                                      // 0x026C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TSubclassOf<class UObject>>            TaskClasses;                                       // 0x0270(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	class UFunction*                              InitInstanceFunction;                              // 0x0280(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FVersePersistentVar>            PersistentVars;                                    // 0x0288(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FVerseSessionVar>               SessionVars;                                       // 0x0298(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class FName, struct FVerseClassVarAccessors> VarAccessors;                                      // 0x02A8(0x0050)(NativeAccessSpecifierPublic)
	struct FVerseEffectSet                        ConstructorEffects;                                // 0x02F8(0x0004)(NoDestructor, NativeAccessSpecifierPublic)
	class FName                                   MangledPackageVersePath;                           // 0x02FC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 PackageRelativeVersePath;                          // 0x0308(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FName, class FName>                DisplayToMangledNameMap;                           // 0x0318(0x0050)(NativeAccessSpecifierPublic)
	uint8                                         Pad_368[0x18];                                     // 0x0368(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	class UClassCookedMetaData*                   CachedCookedMetaDataPtr;                           // 0x0380(0x0008)(ZeroConstructor, EditorOnly, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
