...
{
public:
	TMulticastInlineDelegate<void(class UAsyncAction_RegisterGameplayMessageReceiver* ProxyObject)> OnMessageReceived;                                 // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UAsyncAction_RegisterGameplayMessageReceiver* ProxyObject)> HandleSavedState;                                  // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UAsyncAction_RegisterGameplayMessageReceiver* ProxyObject)> HandleStateCleared;                                // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	class AGameplayMessageReplicator*             MessageReplicator;                                 // 0x00D8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
