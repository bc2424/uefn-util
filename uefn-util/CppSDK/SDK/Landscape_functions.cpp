...
// Function Landscape.LandscapeProxy.DeleteUnusedLayers
...
void ALandscapeProxy::DeleteUnusedLayers()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("LandscapeProxy", "DeleteUnusedLayers");
...
// Function Landscape.Landscape.ForceLayersFullUpdate
// (Final, RequiredAPI, Native, Public, BlueprintCallable, EditorOnly)
...
void ALandscape::ForceLayersFullUpdate()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Landscape", "ForceLayersFullUpdate");
