...
// Function MeshCosmetics.MeshCosmeticsApparelItemDefinition.TryDetermineSlotType
// (Final, Exec, Native, Protected, EditorOnly)

void UMeshCosmeticsApparelItemDefinition::TryDetermineSlotType()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MeshCosmeticsApparelItemDefinition", "TryDetermineSlotType");
