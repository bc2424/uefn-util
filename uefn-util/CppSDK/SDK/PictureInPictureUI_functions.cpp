...
// Function PictureInPictureUI.PictureInPicturePanelWidget.ResetPiPPositionToDefault
// (Final, Native, Protected)

void UPictureInPicturePanelWidget::ResetPiPPositionToDefault()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PictureInPicturePanelWidget", "ResetPiPPositionToDefault");
