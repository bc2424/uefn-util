...
public:
	...
	struct FZoneLaneProfileRef                    LaneProfile;                                       // 0x004C(0x001C)(NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bReverseLaneProfile;                               // 0x0068(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FZoneLaneProfileRef                    SourceLaneProfile;                                 // 0x0024(0x001C)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FZoneLaneProfileRef                    DestinationLaneProfile;                            // 0x0040(0x001C)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	EZoneGraphLaneRoutingCountRule                SourceOutgoingConnections;                         // 0x005C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EZoneGraphLaneRoutingCountRule                DestinationIncomingConnections;                    // 0x005D(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
