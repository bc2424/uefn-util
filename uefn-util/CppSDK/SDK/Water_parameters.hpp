...
// 0x0001 (0x0001 - 0x0000)
struct WaterBodyComponent_SetWaterBodyStaticMeshEnabled final
{
public:
...
{
public:
	TSoftObjectPtr<class AWaterZone>              InWaterZoneOverride;                               // 0x0000(0x0030)(ConstParm, Parm, OutParm, ReferenceParm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
