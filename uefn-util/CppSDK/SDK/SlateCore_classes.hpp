...
// 0x0BE8 (0x0C18 - 0x0030)
class USlateThemeManager final : public UObject
{
public:
	uint8                                         Pad_30[0x438];                                     // 0x0030(0x0438)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGuid                                  CurrentThemeId;                                    // 0x0468(0x0010)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FStyleColorList                        ActiveColors;                                      // 0x0478(0x07A0)(Edit, Transient, NativeAccessSpecifierPublic)
