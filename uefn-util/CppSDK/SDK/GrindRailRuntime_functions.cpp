...
// Function GrindRailRuntime.FortGrindRail.ConnectSelectedRails
// (Final, Native, Private, EditorOnly)

void AFortGrindRail::ConnectSelectedRails()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortGrindRail", "ConnectSelectedRails");
...
// Function GrindRailRuntime.FortGrindRail.GetBestPointToSnapTo
// (Final, Native, Protected, HasOutParams, BlueprintCallable, EditorOnly)
// Parameters:
// int32                                   PointToSnap                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TArray<class AFortGrindRail*>           SnapAllowedRails                                       (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
// struct FFortRailPointSnapData           ReturnValue                                            (Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)

struct FFortRailPointSnapData AFortGrindRail::GetBestPointToSnapTo(int32 PointToSnap, const TArray<class AFortGrindRail*>& SnapAllowedRails)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortGrindRail", "GetBestPointToSnapTo");

	Params::FortGrindRail_GetBestPointToSnapTo Parms{};

	Parms.PointToSnap = PointToSnap;
	Parms.SnapAllowedRails = std::move(SnapAllowedRails);
...
// Function GrindRailRuntime.FortGrindRail.RemoveConnectionsFromSelectedRails
// (Final, Native, Private, EditorOnly)

void AFortGrindRail::RemoveConnectionsFromSelectedRails()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortGrindRail", "RemoveConnectionsFromSelectedRails");
...
// Function GrindRailRuntime.FortGrindRail.SnapPoint
// (Final, Native, Protected, HasOutParams, BlueprintCallable, EditorOnly)
// Parameters:
// int32                                   PointIndex                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FFortRailPointSnapData           SnapData                                               (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)

void AFortGrindRail::SnapPoint(int32 PointIndex, const struct FFortRailPointSnapData& SnapData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortGrindRail", "SnapPoint");

	Params::FortGrindRail_SnapPoint Parms{};

	Parms.PointIndex = PointIndex;
	Parms.SnapData = std::move(SnapData);
...
// Function GrindRailRuntime.FortGrindRail.SplitRail
// (Final, Native, Private, EditorOnly)

void AFortGrindRail::SplitRail()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortGrindRail", "SplitRail");
...
bool AFortGrindRail::GetCameraModifierOverrideClass(TSubclassOf<class UFortCameraModifier_Grinding>* OutCameraModifierOverrideClass) const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("FortGrindRail", "GetCameraModifierOverrideClass");
