...
// 0x0010 (0x0010 - 0x0000)
struct BuildingGameplayActorLaserGrid_CosmeticLaserConnectionsUpdated final
{
public:
	TArray<struct FLaserGridConnectionEntry>      NewLaserGridConnections;                           // 0x0000(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
