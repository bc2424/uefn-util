...
// Parameters:
// class FString                           ParamName                                              (Parm, OutParm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class FString                           OptionName                                             (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TSet<TSoftObjectPtr<class UDataTable>>  ReturnValue                                            (Parm, OutParm, ReturnParm, UObjectWrapper, NativeAccessSpecifierPublic)

TSet<TSoftObjectPtr<class UDataTable>> UCustomizableObject::GetIntParameterOptionDataTable(class FString* ParamName, const class FString& OptionName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CustomizableObject", "GetIntParameterOptionDataTable");

	Params::CustomizableObject_GetIntParameterOptionDataTable Parms{};
...
// (Final, Native, Public, HasOutParams, BlueprintCallable, EditorOnly)
// Parameters:
// struct FBakingConfiguration             InBakingConfiguration                                  (ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)

void UCustomizableObjectInstance::Bake(const struct FBakingConfiguration& InBakingConfiguration)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CustomizableObjectInstance", "Bake");

	Params::CustomizableObjectInstance_Bake Parms{};

	Parms.InBakingConfiguration = std::move(InBakingConfiguration);
...
void UCustomizableObjectInstance::SetDefaultValue(const class FString& ParamName)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CustomizableObjectInstance", "SetDefaultValue");
...
struct FInstancedStruct UCustomizableObjectInstance::GetExtensionInstanceData(const class UCustomizableObjectExtension* Extension) const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CustomizableObjectInstance", "GetExtensionInstanceData");
...
void ACustomizableSkeletalMeshActor::EnableDebugMaterial(bool bEnableDebugMaterial)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CustomizableSkeletalMeshActor", "EnableDebugMaterial");
...
void ACustomizableSkeletalMeshActor::SetDebugMaterial(class UMaterialInterface* InDebugMaterial)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CustomizableSkeletalMeshActor", "SetDebugMaterial");
...
void ACustomizableSkeletalMeshActor::SwitchComponentsMaterials(class UCustomizableObjectInstance* Instance)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CustomizableSkeletalMeshActor", "SwitchComponentsMaterials");
