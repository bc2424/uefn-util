...
TArray<class FString> URigHierarchyController::GeneratePythonCommands()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("RigHierarchyController", "GeneratePythonCommands");

	Params::RigHierarchyController_GeneratePythonCommands Parms{};
...
TArray<struct FRigElementKey> URigHierarchyController::ImportBonesFromAsset(const class FString& InAssetPath, class FName InNameSpace, bool bReplaceExistingBones, bool bRemoveObsoleteBones, bool bSelectBones, bool bSetupUndo)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("RigHierarchyController", "ImportBonesFromAsset");

	Params::RigHierarchyController_ImportBonesFromAsset Parms{};
...
TArray<struct FRigElementKey> URigHierarchyController::ImportCurvesFromAsset(const class FString& InAssetPath, class FName InNameSpace, bool bSelectCurves, bool bSetupUndo)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("RigHierarchyController", "ImportCurvesFromAsset");

	Params::RigHierarchyController_ImportCurvesFromAsset Parms{};
