...
public:
	...
	TDelegate<void(const struct FTargetingRequestHandle& TargetingRequestHandle)> TargetingRequestDynamicDelegate;                   // 0x0020(0x0014)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	class FName                                   SourceSocketName;                                  // 0x0028(0x000C)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                SourceObject;                                      // 0x0038(0x0008)(BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class UTargetingPreset*                       TargetingPreset;                                   // 0x0000(0x0008)(ZeroConstructor, EditorOnly, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FString, class FString>            DebugScratchPadStrings;                            // 0x0008(0x0050)(EditorOnly, NativeAccessSpecifierPublic)
	TArray<struct FTargetingDefaultResultData>    CachedTargetResults;                               // 0x0058(0x0010)(ZeroConstructor, EditorOnly, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
